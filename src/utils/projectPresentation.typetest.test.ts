...
/**
 * FR-3 continued: an invalid/unlisted `Status` or `TechKey` passed to the
 * seam must be a TypeScript compile error, never a silent runtime fallback.
 ...
 */
describe("projectPresentation.typetest.ts proves Status/TechKey maps are closed unions (FR-3)", () => {
