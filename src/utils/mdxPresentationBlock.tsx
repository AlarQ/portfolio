 ...
 */
export const MDX_FRAME_CLASS = "mx-auto max-w-full rounded-lg border border-border p-4";
...
export function Pre({ children, ...props }: ComponentPropsWithoutRef<"pre">) {
  ...
  return (
    <pre className="max-w-full overflow-x-auto rounded-lg border border-border p-4" {...props}>
      {children}
    </pre>
  );
}
