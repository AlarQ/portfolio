...
date: 2026-07-27
categories: ["Rust", "Engineering", "AI"]
---
...
My point is also that the thing which makes those fixes survivable turns out to
be the same property that makes the language good to hand an agent.

So the criterion I now apply when picking a language for work I intend to hand off:
not how fast I can write it, but how much its compiler explains to whoever gets it
wrong.
